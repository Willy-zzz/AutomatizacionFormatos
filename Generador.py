...
# Función para obtener la ruta correcta del archivo (funciona con .py y .exe)
def resource_path(relative_path):
    try:
        # PyInstaller crea esta carpeta temporal con los recursos
...
def generar_word():
    try:
        ...
        # Cargar plantilla Word usando resource_path para compatibilidad exe
        ruta_plantilla = resource_path(os.path.join('Plantillas', 'Plantilla_FSV.docx'))
